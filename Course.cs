...
namespace POO_Project
{
    class Course
    {
        ...
        public Course(string CourseName, Teacher CourseTeacher, string CourseDay, string StartingHour, string EndingHour, string Content)
        {
        ...
        {
            return "The course " + courseName + " is taking place every " + CourseDay + " between " + startingHour + " and " + endingHour + " and your teacher is " + courseTeacher.TeacherName();
        }
